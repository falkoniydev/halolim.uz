...
// 	// Form submit bo'lganda API so'rovi chaqiriladi
// 	const onFinish = (values: any) => {
// 		dispatch(loginUser(values));
// 	};

// 	// isAuthenticated o'zgarganida, foydalanuvchi muvaffaqiyatli login bo'lganda home sahifasiga o'tadi
// 	useEffect(() => {
// 		if (isAuthenticated) {
...
import LoadingBar from "react-top-loading-bar"; // Top-loader import qilindi
...
const Login = () => {
	...
	const dispatch = useDispatch<AppDispatch>();
	const loaderRef = useRef(null); // Loading bar uchun ref
	...
	useEffect(() => {
		if (isAuthenticated) {
			(loaderRef.current as any).complete(); // Loaderni to'xtatish
			navigate("/");
		}
	}, [isAuthenticated, navigate]);
